...
Both share =bebop--reap-runtime=, which does the runtime half. The only
difference is the Solo frame: kill asks before closing it (your buffers
may be worth keeping), teardown does not (the session is going away).
