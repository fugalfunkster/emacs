...
=bebop-state.json= holds *your relationship to* that state — ack
...
states as of your last visit, persisted in =bebop-state.json= session
meta so an Emacs restart doesn't re-flash the world as new. A glyph
