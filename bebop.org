...
visited, a pipeline that failed, or unresolved MR comments you
haven't seen (stale external data never qualifies — old news doesn't
earn the lane). A projection, not a move: the row still renders in
